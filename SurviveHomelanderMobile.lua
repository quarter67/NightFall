...
-- BUILD: 2026-06-04-MOBILE-UI-FIX2
...
-- Default mobile spawn: stacked above the game's bottom-right door/interact button.
...
print("[SurviveHomelander] Loaded - Mobile build 2026-06-04-MOBILE-UI-FIX2")
if State.isMobile then
